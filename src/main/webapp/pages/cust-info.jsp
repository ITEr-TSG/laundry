			...
			<div class="layui-col-md12">
				<div id="oldCustInfo" class="layui-col-md4 layui-col-md-offset4">
					...
					<div class="layui-form cust-info">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" readonly="readonly"
									value="${cust.custNick}" required lay-verify="required"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="email" id="changeCustInfoEmail" readonly="readonly"
									value="${cust.custEmail}" required
									lay-verify="required" placeholder="请输入邮箱"
									id="regiterEmailInput" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input readonly="readonly"
									...
									value="${cust.custIntegral}"required
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<button id="showChangeInfo" class="layui-btn layui-btn-radius layui-btn-normal"
									type="button">
				...
				<div id="newCustInfo" hidden="hidden" class="layui-col-md4 layui-col-md-offset4">
					<h1 align="center">修改信息</h1>
					<form class="layui-form" action="${PATH}/cust/changeCustInfo" method="post">
			...
			<div class="layui-col-md10 layui-col-md-offset1" style="margin-top: 10px">
				<div class="layui-form">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" placeholder="请输入金额" id="input_money" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">积分</label>
		...
		layui.use( 'layer', function() {
			...
			layer.open({
				  ...
				  $.ajax({
					  ...
					  success:function(res){
						  if(res.code==100){
								 layer.msg(res.extend.msg,{icon:6,time:5000},function(){
									 location.reload();   
								 }) 
							}else{
