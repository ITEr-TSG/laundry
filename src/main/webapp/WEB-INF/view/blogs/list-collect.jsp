					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									<table id="collectListTb"
										class="table table-responsive table-hover"
										lay-filter="collectListTbFilter">
		...
		function renderTb() {
			...
			layui.use(['table','util'], function() {
				...
				table.render({
					elem : '#collectListTb',
					height : 312,
					url : '${PATH}/blogsCollect/getCollectList',
					text : {
						none : '未找到相关数据'
					},
					id:"collectListTbId",
				...
				table.on('tool(collectListTbFilter)', function(obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
					...
					if (layEvent === 'detail') { //查看
						var id=data.blogId
						$.ajax({
							url:"${PATH}/blogs/getById/"+id,
							method:"get",
							success:function(res){
								$("#detailBlogDiv").html(res.extend.blog.blogText);
								  $("#detailBlogtitle").html(res.extend.blog.blogTitle);
							},error:function(){
